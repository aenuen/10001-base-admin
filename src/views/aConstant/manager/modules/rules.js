import { validateAllCn, validateEmail, validateMobile, validateRequire, validateUsername } from 'methods-libs'
...
export const MobileRule = {
  newEmail: [
    { validator: (rule, value, callback) => validateMobile(rule, value, callback) }
  ]
}
...
export const DetailRule = {
  ...
  petName: [
    { validator: (rule, value, callback) => validateRequire(rule, value, callback, fields.petName, '填写', 2, 20) }
  ],
  realName: [
    { validator: (rule, value, callback) => validateAllCn(rule, value, callback, fields.realName, 2, 20) }
  ],
  email: [
    { validator: (rule, value, callback) => validateEmail(rule, value, callback) }
  ],
  ...
  roles: [
    { validator: (rule, value, callback) => validateRequire(rule, value, callback, fields.roles, '选择') }
  ]
}
