      ...
      <el-row>
        <el-col>
          <el-form-item prop="password" :label="`旧${fields['password']}`" :label-width="labelWidth">
            <el-input v-model.trim="postForm.password" :placeholder="`旧${fields['password']}`" clearable show-password maxlength="30" style="width:300px" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col>
          <el-form-item prop="passwordOne" :label="`新${fields['password']}`" :label-width="labelWidth">
            <el-input ref="passwordOne" v-model.trim="postForm.passwordOne" :placeholder="`新${fields['password']}`" clearable show-password maxlength="30" style="width:300px" />
          </el-form-item>
        </el-col>
      </el-row>
      <el-row>
        <el-col>
          <el-form-item prop="passwordTwo" :label="`确认${fields['password']}`" :label-width="labelWidth">
            <el-input ref="passwordTwo" v-model.trim="postForm.passwordTwo" :placeholder="`确认${fields['password']}`" clearable show-password maxlength="30" style="width:300px" />
          </el-form-item>
        </el-col>
      </el-row>
